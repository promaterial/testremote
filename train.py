...
# model = YOLO("yolo11m-seg.yaml").load("weights/yolo11m-seg.pt")
    model = YOLO(r'ultralytics/cfg/models/11/yolo11-scdown+dff.yaml')

    # 定义训练参数，添加默认值、范围和中文注释
    train_params = {
        'data': r"C:\Users\huang\Desktop\Steel_surface_defect_detection\ultralytics\cfg\datasets\mydata.yaml",  # 数据集配置文件路径，需要自定义修改
        ...
        'project': "ModelE-只有C3k2DFF",  # 项目名称，保存训练结果的目录，默认值 None
